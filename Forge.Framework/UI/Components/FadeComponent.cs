...
namespace Forge.Framework.UI.Components{
    public delegate void FadeStateChange(FadeComponent.FadeState state);

    /// <summary>
    ///   allows a UI element to be faded in and out. Required element to be IUIInteractiveComponent for certain settings.
    /// </summary>
    public class FadeComponent : IUIComponent, IAcceptMouseEntryEvent, IAcceptMouseExitEvent{
